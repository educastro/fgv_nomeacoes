            ...
            with open(endereco_do_arquivo, encoding='utf-8') as ato_xml:
                ...
                for trecho in texto_da_portaria.split("</p>"):
                    if ("nomear" in trecho) and ("das 1" in trecho or "das-1" in trecho) and (tipo_da_portaria != "Retificação"):
                        ...
                        regex_nomeacao_tipo_9 = re.search(r"nomear\W*\s*[oa]*\s.+federal\sdo\sbrasil\saposentada\s(.+),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_10 = re.search(r"nomear\W*\s*[oa]*\s.+federal\sdo\sbrasil\s(.+),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_11 = re.search(r"nomear\W*\s*[oa]*\s.+federal\sdra*\W*\s(.+),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_12 = re.search(r"nomear\W*\s*[oa]*\s.+federal\sdo\sbrasil,*\s(.+?),*\smatrícula.+\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_13 = re.search(r"nomear\W*\s*[oa]*\s.+federal\ss*r*a*.\s(.+),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_14 = re.search(r"nomear\W*\s*[oa]*\s.+federal\s(.+),*\spara\so\s.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_15 = re.search(r"nomear\W*\s*(.+)\s\(nr\sord\s\d+\),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_16 = re.search(r"nomear\W*\s*(.+),*\sportador[ao]\sdo\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_17 = re.search(r"nomear\W*\s*[oa]*\ssenhora*\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_18 = re.search(r"nomear\W*\s*[oa]*\ssenhora*\s(.+?),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_19 = re.search(r"nomear\W*\s*[oa]*\sprofessora*\sdo\smagistério\ssuperior,*\smatrícula\ssiape\s\d+,*\s(.+?),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_20 = re.search(r"nomear\W*\s*a\spartir\sde\s\d+\sde\s\w+\sde\s\d+\W*\s(.+),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_21 = re.search(r"nomear\W*\s*a\spartir\sde\s\d+\sde\s\w+\sde\s\d+\W*(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_22 = re.search(r"nomear\W*\s*a\spartir\sde\s\d.\sde\s\w+\sde\s\d+,\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_23 = re.search(r"nomear\W*\s*[oa]*\stécnic[oa]\sem\sassuntos\seducacionais,*\s\d+.\d+.\d+,\smatrícula\ssiape\s\d+,\s(.+?),*\scpf\s.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_24 = re.search(r"nomear\W*\s*[oa]*\stécnico\sem\sassuntos\seducacionais\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_25 = re.search(r"nomear\W*\s*[oa]*\sagente\sadministrativo,*\s\d+.\d+.\d+,*\smatrícula\ssiape\s\d+,*\s(.+?),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_26 = re.search(r"nomear\W*\s*[oa]*\sprocuradora*\sfederal\s(.+?),*\s*matrícula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_27 = re.search(r"nomear\W*\s*a\s\w+,\s\d+.\d+.\d+,\smatrícula\ssiape\s\d+,\s(.+?),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_28 = re.search(r"nomear\W*\s*(.+),*\scpf.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_29 = re.search(r"nomear\W*\s*[oa]*\sarquitet[oa]\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_30 = re.search(r"nomear\W*\s*[oa]*\sassistente\stécnico-*administr*ativo\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_31 = re.search(r"nomear\W*\s*[oa]*\sanalista\stécnico-*\s*administrativo\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_32 = re.search(r"nomear\W*\s*[oa]*\stécnic[oa]\sdo\sseguro\ssocial\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_33 = re.search(r"nomear\W*\s*(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_34 = re.search(r"nomear\W*\s*(.+),*\smatr[ií]cula.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_35 = re.search(r"nomear\W*\s*o\scmg\s\(im\)\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_36 = re.search(r"nomear\W*\s*\ba contar de \d+ de \w+ de \d+\b,\s[oa]*\s\w+\s\w+\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_37 = re.search(r"nomear\W*\s*[oa]*\scel\sinf*t*\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_38 = re.search(r"nomear\W*\s*[oa]*\sservidora*\s(.+?),*\ssiape.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_39 = re.search(r"nomear\W*\s*[oa]*\ssoldad[oa]\s\(fab\)\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_40 = re.search(r"nomear\W*\s*[oa]*\stenente-coronel\saviador\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_41 = re.search(r"nomear\W*\s*(.+?),*\s\(nr\sord\s.+para\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_42 = re.search(r"nomear\W*\s*[oa]*\scontra\salmirante\s\(im\)\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_43 = re.search(r"nomear\W*\s*[oa]*\sso-av-cv\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_44 = re.search(r"nomear\W*\s*[oa]*\scoronel\saviador\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_45 = re.search(r"nomear\W*\s*[oa]*\sbrigadeiro\sdo\sar\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_46 = re.search(r"nomear\W*\s*[oa]*\scoronel\sqmb\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_47 = re.search(r"nomear\W*\s*[oa]*\scapitã[oa]\sde\smar\se\sguerra\s\(im\)\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_48 = re.search(r"nomear\W*\s*[oa]*\spolicial\s\w+\sfederal\s(.+),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_49 = re.search(r"nomear\W*\s*[oa]\sperit[oa]*\s\w+\sfederal\s(.+?),*\s*para\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_50 = re.search(r"nomear\W*\s*[oa]*\s\d.\ssg-*el\s(.+?),*\s*para\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_51 = re.search(r"nomear\W*\s*[oa]*\s\d.\ssgt\sqe\s(.+?),*\s*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_52 = re.search(r"nomear\W*\s*(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_53 = re.search(r"nomear\W*\s*[oa]*\sagente\sadministrativo\s(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_54 = re.search(r"nomear\W*\s*[oa]*\sagente\sde\stelecomunicação\se\seletricidade\s(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_55 = re.search(r"nomear\W*\s*[oa]*\scontador\s(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_56 = re.search(r"nomear\W*\s*para\so\scargo\s.+\scódigo\sdas[\s-](\d+.\d+),\s[oa]*\ssra*\.\s(.+),\scpf\s", trecho)

                        if regex_nomeacao_tipo_56 and encontrado == False:
                            regex = "regex_nomeacao_tipo_56"
                            encontrado = True
                            nome_do_servidor = regex_nomeacao_tipo_56.group(2).split(",")[0]
                            cargo_simbolo = regex_nomeacao_tipo_56.group(1)

                        regex_nomeacao_tipo_57 = re.search(r"nomear\W*\s*para\so\scargo\s.+\scódigo\sdas[\s-](\d+.\d+),\s.+de\snavegação,\s\d+.\d+.\d+\s(.+),\scpf\s.+", trecho)

                        if regex_nomeacao_tipo_57 and encontrado == False:
                            regex = "regex_nomeacao_tipo_57"
                            encontrado = True
                            nome_do_servidor = regex_nomeacao_tipo_57.group(2).split(",")[0]
                            cargo_simbolo = regex_nomeacao_tipo_57.group(1)

                        regex_nomeacao_tipo_58 = re.search(r"nomear\W*\s*(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_59 = re.search(r"nomear\W*\s*(.+),*\s[nd]o\scargo.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_60 = re.search(r"nomear\W*\s*(.+?),*\s*para,*\sexercer.+das[\s-](\d+.\d+)", trecho)
                        ...
                        regex_nomeacao_tipo_61 = re.search(r"código\sdas[\s-](\d+.\d+)\se\snomear\s(.+)\spara\s[te]", trecho)

                        if regex_nomeacao_tipo_61 and encontrado == False:
                            regex = "regex_nomeacao_tipo_61"
                            encontrado = True
                            nome_do_servidor = regex_nomeacao_tipo_61.group(2).split(",")[0]
                            cargo_simbolo = regex_nomeacao_tipo_61.group(1)
