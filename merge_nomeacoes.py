        ...
        with open(filepath, encoding='utf-8') as ato_xml:
            ...
            for trecho in texto_da_portaria.split("</p>"):
                if ("nomear" in trecho) and ("das 1" in trecho or "das-1" in trecho) and (tipo_da_portaria != "Retificação"):
                    ...
                    regex_nomeacao_tipo_11 = re.search(r"nomear\W*\s*[oa]\sarquitet[oa]\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_12 = re.search(r"nomear\W*\s*[oa]\sassistente\stécnico-administrativo\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_13 = re.search(r"nomear\W*\s*[oa]\sanalista\stécnico-administrativo\s(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_14 = re.search(r"nomear\W*\s*(.+?),*\smatr[íi]cula.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_15 = re.search(r"nomear\W*\s*(.+),*\smatr[ií]cula.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_16 = re.search(r"nomear\W*\s*o\scmg\s\(im\)\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_17 = re.search(r"nomear\W*\s*\ba contar de \d+ de \w+ de \d+\b,\s[oa]\s\w+\s\w+\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_18 = re.search(r"nomear\W*\s*[oa]\scel\sinf\s(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_19 = re.search(r"nomear\W*\s*[oa]\sservidora*\s(.+?),*\ssiape.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_20 = re.search(r"nomear\W*\s*(.+?),*\spara\sexercer.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_21 = re.search(r"nomear\W*\s*[oa]\sagente\sadministrativo\s(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_22 = re.search(r"nomear\W*\s*[oa]\scontador\s(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_23 = re.search(r"nomear\W*\s*para\so\scargo\s.+\scódigo\sdas-*(\d+.\d+),\s[oa]\ssra*\.\s(.+),\scpf\s", trecho)

                    if regex_nomeacao_tipo_23 and encontrado == False:
                        regex = "regex_nomeacao_tipo_23"
                        encontrado = True
                        nome_do_servidor = regex_nomeacao_tipo_23.group(2).split(",")[0]
                        cargo_simbolo = regex_nomeacao_tipo_23.group(1)

                    regex_nomeacao_tipo_24 = re.search(r"nomear\W*\s*para\so\scargo\s.+\scódigo\sdas-*(\d+.\d+),\s.+de\snavegação,\s\d+.\d+.\d+\s(.+),\scpf\s.+", trecho)

                    if regex_nomeacao_tipo_24 and encontrado == False:
                        regex = "regex_nomeacao_tipo_24"
                        encontrado = True
                        nome_do_servidor = regex_nomeacao_tipo_24.group(2).split(",")[0]
                        cargo_simbolo = regex_nomeacao_tipo_24.group(1)

                    regex_nomeacao_tipo_25 = re.search(r"nomear\W*\s*(.+?),*para\so\scargo.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_26 = re.search(r"nomear\W*\s*(.+),*\s[nd]o\scargo.+das[\s-](\d+.\d+)", trecho)
                    ...
                    regex_nomeacao_tipo_27 = re.search(r"nomear\W*\s*(.+?),*.+das[\s-](\d+.\d+)", trecho)
